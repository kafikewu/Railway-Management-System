...
int options()
{
    while(1)
    {
        ...
        cout<<"5. Edit the trains informations"<<endl;
        cout<<"6. Put in informations about trains"<<endl;
...
void change_current_info()
{
    ...
    int train_no;
    cin>>train_no;
    cout<<"Please enter what do you want to change: "<<endl;
    cout<<"1. Destination";
    cout<<"2. Departing time";
